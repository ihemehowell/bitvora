  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-400 flex items-center justify-center text-black flex-shrink-0">
          <Icon size={24} />
        </div>
        {index < 4 && (
      ...
      <div className="pb-10">
        ...
        <h5 className="text-white font-semibold text-lg mb-2">{title}</h5>
