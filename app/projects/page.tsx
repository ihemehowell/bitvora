      ...
      <div className="min-h-screen">
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              <span className="text-primary text-sm font-medium mono mb-4 block">OUR PORTFOLIO</span>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link href="/contact">
                  <button className="px-8 py-4 bg-accent hover:bg-accent/80 text-foreground rounded-xl border border-border transition-all duration-300">
                    Contact Us
                  </button>
                </Link>
              </div>
